...
namespace Xbim.Geometry.Scene
{
    ...
    /// </summary>
    public class Xbim3DModelContextLegacy : ICanLog
    {
        ...
        {
            private readonly Xbim3DModelContextLegacy _modelContext;
        ...
        private class XbimCreateContextHelper : IDisposable
        {
            ...
            public XbimCreateContextHelper(Xbim3DModelContextLegacy modelContext, IModel model, IfcRepresentationContextCollection contexts)
            {
                _modelContext = modelContext;
                Model = model;
                Contexts = contexts;
            ...
            public XbimCreateContextHelper(Xbim3DModelContextLegacy modelContext, IModel model, IfcRepresentationContextCollection contexts, ILogger logger)
        ...
        static Xbim3DModelContextLegacy()
        {
        ...
        public Xbim3DModelContextLegacy(IModel model, ILoggerFactory loggerFactory, string contextType = "model", string requiredContextIdentifier = null)
            : this(model, contextType, requiredContextIdentifier, loggerFactory?.CreateLogger<Xbim3DModelContextLegacy>(), loggerFactory)
        {
        }
        ...
        /// <param name="loggerFactory"></param>
        public Xbim3DModelContextLegacy(IModel model, string contextType = "model", string requiredContextIdentifier = null,
        ...
        /// <summary>
        /// Gets the mode associated with this <see cref="Xbim3DModelContextLegacy"/>
        /// </summary>
        public IModel Model
        {
            get { return _model; }
