...
namespace Xbim.Geometry.Engine.Interop.Primitives
{
    ...
    /// </summary>
    internal class NativeSurface : IXSurface, IDisposable
    {
        private NativeSurfaceHandle _handle;
        private readonly XSurfaceType _surfaceType;

        internal NativeSurface(NativeSurfaceHandle handle, XSurfaceType surfaceType)
        {
        ...
        internal NativeSurfaceHandle Handle =>
            _handle ?? throw new ObjectDisposedException(nameof(NativeSurface));
    ...
    /// </summary>
    internal class NativePlane : NativeSurface, IXPlane
    {
        public IXPoint Location { get; }
        public IXDirection Axis { get; }
        public IXDirection RefDirection { get; }

        internal NativePlane(NativeSurfaceHandle handle, IXPoint location, IXDirection axis, IXDirection refDirection)
