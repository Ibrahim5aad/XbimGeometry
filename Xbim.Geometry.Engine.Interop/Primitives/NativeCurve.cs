...
namespace Xbim.Geometry.Engine.Interop.Primitives
{
    ...
    /// </summary>
    internal class NativeCurve : IXCurve, IDisposable
    {
        private NativeCurveHandle _handle;
        private readonly XCurveType _curveType;

        internal NativeCurve(NativeCurveHandle handle, XCurveType curveType)
        {
        ...
        internal NativeCurveHandle Handle =>
            _handle ?? throw new ObjectDisposedException(nameof(NativeCurve));
