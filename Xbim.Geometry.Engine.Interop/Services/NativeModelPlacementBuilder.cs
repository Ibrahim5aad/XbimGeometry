...
namespace Xbim.Geometry.Engine.Interop.Services
{
    ...
    /// </summary>
    internal class NativeModelPlacementBuilder : IXModelPlacementBuilder
    {
        private readonly NativeModelGeometryService _modelService;
        private readonly NativeGeometryFactory _geometryFactory;
        ...
        public NativeModelPlacementBuilder(NativeModelGeometryService modelService, ILogger logger)
        {
            _modelService = modelService ?? throw new ArgumentNullException(nameof(modelService));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _geometryFactory = (NativeGeometryFactory)modelService.GeometryFactory;
