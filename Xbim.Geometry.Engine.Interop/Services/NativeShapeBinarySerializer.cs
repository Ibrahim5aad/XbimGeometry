...
namespace Xbim.Geometry.Engine.Interop.Services
{
    ...
    /// </summary>
    internal class NativeShapeBinarySerializer : IXShapeBinarySerializer
    {
        private readonly ILogger _logger;

        public NativeShapeBinarySerializer(ILogger logger)
        {
        ...
        public byte[] ToArray(IXShape shape, bool withTriangles = false, bool withNormals = false)
        {
            ...
            var nativeShape = shape as NativeShape
        ...
        /// </summary>
        internal static string ToBrep(NativeShape shape)
        {
