...
namespace Xbim.Geometry.Engine.Interop.Services
{
    ...
    /// </summary>
    internal class NativeGeometryEngineV6 : IXGeometryEngineV6, IDisposable
    {
        private readonly NativeModelGeometryService _service;
        private readonly ILogger _logger;

        public NativeGeometryEngineV6(NativeModelGeometryService service, ILoggerFactory loggerFactory)
        {
            _service = service ?? throw new ArgumentNullException(nameof(service));
            _logger = loggerFactory.CreateLogger<NativeGeometryEngineV6>();
        }
